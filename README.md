...
## ChiliPeppr Widget / Auto-Level -G2
...
| chilipeppr.load() URL | http://raw.githubusercontent.com/blwn23/widget-autolevel-g2/master/auto-generated-widget.html |
| Edit URL              | http://ide.c9.io/blwn/autolevel-widget-g2 |
| Github URL            | http://github.com/blwn23/widget-autolevel-g2 |
| Test URL              | https://preview.c9users.io/blwn/autolevel-widget-g2/widget.html |
  ...
  function() {
    ...
    cprequire(
      ...
      function(myObjWidgetAutolevel) {
        ...
        console.log("Widget / Auto-Level -G2 just got loaded.", myObjWidgetAutolevel);
